...
from model.model_nmt import Model
from model.data_util import load_data, load_and_preprocess_data, UNK_TOKEN, START_TOKEN, END_TOKEN, PAD_TOKEN
from model.util import Progbar, minibatches, padded_batch, tokens_to_sentences, padded_batch_lr
from model.rouge import rouge_n
...
class SequencePredictor(Model):
    ...
    def add_prediction_op(self):
        ...
        pred_helper = tf.contrib.seq2seq.GreedyEmbeddingHelper(self.pretrained_embeddings, start_tokens, end_token)
