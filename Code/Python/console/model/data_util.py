...
GLOVE_PATH = '/Users/sofiasf/Data224n/Glove/pruned'
# GLOVE_PATH = '/app/glove'
...
def preprocess_input(input_data, vocabulary):
    tokenized = nltk.word_tokenize(normalize_name(input_data))
    fake_data = [(tokenized, ['fake'])]
    data_idx = token_to_idx(fake_data, vocabulary)
    output = data_idx[0][0]
    return output
